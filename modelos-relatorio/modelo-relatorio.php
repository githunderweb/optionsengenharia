<div class="card">
    <form id="frm-modelos-relatorio" action="./modelos-relatorio/modelo-relatorio-acao.php" method='POST' class='needs-validation' novalidate='novalidate'>

        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Novo modelo de relatório</h5>
                ...
                <div class="row-campo">
                    ...
                    <div class="row g-3 mb-3 position-relative">
                        ...
                        <div class="col-12 col-md-4 col-lg-3">
                            <!-- <?php
                                    $qr = mysqli_query($connect, "SELECT SUBSTRING(COLUMN_TYPE, 7, LENGTH(COLUMN_TYPE) - 8) AS enum_values FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'campos_modelo_relatorio' AND COLUMN_NAME = 'tipo';");
                                    $dadosQr = explode(",", str_replace("'", "", mysqli_fetch_array($qr)["enum_values"]));
                                    echo "<pre>";
                                    var_dump($dadosQr);
                                    echo "<pre>";
                                    ?> -->
