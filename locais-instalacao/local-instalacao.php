<div class="card">
    <form action="./locais-instalacao/local-instalacao-acao.php" method="POST" class="needs-validation" novalidate="novalidate">

        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Novo local de instalação</h5>
