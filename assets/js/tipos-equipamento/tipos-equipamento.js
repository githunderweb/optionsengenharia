function inicio() {
    ...
    $('#campos-tipo-produto').on('click', '.btn-novo-campo', function () {
    ...
    $('#campos-tipo-produto').on('click', '.btn-excluir-campo', function () {
        if ($('#campos-tipo-produto .row-campo').length > 1)
            $(this).parents('.row-campo').remove();
    });


    // Corrigindo 
    $('form#frm-tipos-equipamento').submit(function (event) {
